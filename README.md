...
원하는 카페를 찾아가기 위해 일일이 검색하는 불편함을 해소하고자 제작한 사이트입니다.<br>
본 서비스는 공공 데이터를 활용하여 지역 카페 목록을 자동으로 앱에 업데이트합니다.<br>
사용자는 현재 위치 또는 원하는 위치를 설정하여 카페 분위기에 맞는 곳을 추천받을 수 있습니다.<br>
최근 SNS에서 인기를 끌고 있는 카페들이 많아짐에 따라 원하는 카테고리를 선택하여 찾을 수 있습니다.
